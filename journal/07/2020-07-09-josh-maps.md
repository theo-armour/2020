...
* Population and other details for every Zip Code in California
...
* The over-arching objective is to be able to go into this level of detail for any location on Earth 
* State and country boundaries are very difficult to see in day light
* Use slider to adjust size of data points - enables OK viewing when zooming into detail
...
* Earth 3D terrain
* Earth Globe with huge exaggerations
* Moon
* Mars
* Bicycle race in Oakland
